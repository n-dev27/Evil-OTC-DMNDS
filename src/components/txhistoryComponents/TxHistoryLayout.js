...
const style = {
  ...
  navItem: `bg-white w-24 py-1 items-center text-lg text-[#566C90]/50 dark:text-white/50 hover:bg-[#8295B3]/50 dark:hover:bg-[#d3d7db] hover:text-[#566B90] dark:hover:text-black cursor-pointer rounded-xl`,
  activeNavItem: `w-24 py-1 items-center shadow-xl text-lg bg-[rgba(70,147,163,1)] text-white rounded-xl`,
}
    ...
    <div className={style.wrapper}>
      {error ? (
        ...
        <div className='w-full flex items-center justify-center sm:justify-between px-2'>
          <div className='hidden sm:flex text-[rgba(255,255,255,0.8)] font_Inter font-bold text-[28px]'>History</div>
          <RadioGroup
